    ...
    return (
      <div>
        <Snackbar
          ...
          message={
            <span id="message-id">
              Please Select a Quantity for the Product
            </span>
          }
        />
        <NumericInput
          ...
          onSubmit={(e) => {
            ...
            if (document.getElementById("NumInputstyle").value > 0) {
              ...
              var PostRequest = {
                ...
                ProdQTY: document.getElementById("NumInputstyle").value,
              };
        ...
        >
          ...
          {this.state.itemJustAdded && (
            <span className="alert alert-primary"> Item added to cart</span>
          )}
        </Form>
      </div>
    );
