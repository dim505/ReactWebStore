  ...
  render() {
    ...
    if (this.state.ShowBrokenSite === true) {
      return (
        <div>
          {" "}
          Cannot contact server, please try again later or refresh the page
        </div>
      );
    } else {
        ...
        <div>
          ...
          <Fade when={this.state.showBody}>
            ...
            <Route
              exact
              path="/"
              component={() => <ProdList products={this.state.products} />}
            />
            <Route path="/ProdDesc/:id" component={ProdDesc} />
            <Route path="/cart" component={Cart} />
            <Route
              path="/MyOrders"
              component={() => <MyOrders auth={this.props.auth} />}
            />
            <Route
              path="/DefMainPage"
              component={() => <DefMainPage auth={this.props.auth} />}
            />
